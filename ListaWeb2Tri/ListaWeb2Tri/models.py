...
class Habilitacao(models.Model):
    ...
    validadeHab = models.CharField(max_length=14)
...
class Corretor(models.Model):
    ...
    nome = models.CharField(max_length=200)
    corretores = models.ManyToManyField("Corretor", blank=True)
    def listacorretores(self):
        return ",".join(str(x)for x in self.corretores.all())
